...
user_table_create = "CREATE TABLE users (user_id integer PRIMARY KEY NOT NULL,\
                    firstName varchar,\
                    lastName varchar,\
                    gender varchar,\
                    level varchar)"
...
time_table_create = "CREATE TABLE time (start_time timestamp NOT NULL primary key,\
                                        hour integer,\
                                        day integer,\
                                        week integer,\
                                        month integer,\
...
# STAGING TABLES
staging_events_copy = (""" copy staging_events from {} iam_role {} json {}""").format(config['S3']['LOG_DATA'], config['IAM_ROLE']['ARN'], config ['S3']['LOG_JSONPATH'])
